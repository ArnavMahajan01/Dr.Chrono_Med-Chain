CREATE DATABASE  IF NOT EXISTS `drchrono` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `drchrono`;
-- MySQL dump 10.13  Distrib 8.0.17, for Win64 (x86_64)
--
-- Host: localhost    Database: drchrono
-- ------------------------------------------------------
...
--
-- Dumping events for database 'drchrono'
--

--
-- Dumping routines for database 'drchrono'
--
